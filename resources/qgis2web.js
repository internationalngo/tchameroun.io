...
map.getView().fit([1214693.547787, 995136.470104, 2632986.319375, 1909584.637638], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">EMPREINTE SPATIALE DE LA MISSION SOLIDARITES INTERNATIONAL TCHAMEROUN</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (243 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Cette plateforme retrace l\'empreinte spatiale de la mission Solidarités International Tchameroun. Les limites et nomenclatures utilisées sont à titre indicatifs et ne font aucune reconnaissance formelle de la part de Solidarités International.';
            }
